...
public class EventHubClientWrapper {
    ...
    public EventHubClientWrapper(PartitioningMethod partitioningMethod, int numPartitions,
        ...
        try {
            ...
            String msg = String.format("Creation of event hub client failed for eventHub %s %s %s %s %s %s with exception", entityPath, partitioningMethod, numPartitions, eventHubNamespace, sasKeyName, sasToken);
            LOG.error(msg, e);
