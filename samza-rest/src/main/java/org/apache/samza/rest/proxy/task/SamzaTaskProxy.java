...
public class SamzaTaskProxy implements TaskProxy {
  ...
  protected JobModel getJobModel(JobInstance jobInstance) {
    ...
    try {
      ...
      // Dong: why does ChangelogPartitionManager use different sources for  SamzaTaskProxy and JobModelManager
      ...
      Map<SystemStreamPartition, String> previousSystemStreamPartitionMapping = sspAssignmentManager.readSystemStreamPartitionAssignment();
      return JobModelManager.readJobModel(config, changeLogPartitionMapping, previousSystemStreamPartitionMapping,
