...
/**
 * Factory for {@link AvroRelConverterWithKeyRecord}
 */
public class AvroRelConverterWithKeyRecordFactory implements SamzaRelConverterFactory {
  ...
  public SamzaRelConverter create(SystemStream systemStream, RelSchemaProvider relSchemaProvider, Config config) {
    return relConverters.computeIfAbsent(systemStream,
        ss -> new AvroRelConverterWithKeyRecord(ss, (AvroRelSchemaProvider) relSchemaProvider, config));
  }
}
