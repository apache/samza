...
public class TestSamzaSqlRelMessageSerde {
  ...
  public void testWithDifferentFields() {
    ...
    Serde serde = new SamzaSqlRelMessageSerdeFactory().getSerde(null, null);
    SamzaSqlRelMessage resultMsg = (SamzaSqlRelMessage) serde.fromBytes(serde.toBytes(message));
