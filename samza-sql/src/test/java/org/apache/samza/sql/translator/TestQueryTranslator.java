...
public class TestQueryTranslator {
  ...
  public void testTranslate() {
    ...
    Assert.assertEquals("testavro-outputTopic-sink", outputPhysicalName);
    Assert.assertEquals(1, specGraph.getInputOperators().size());

    Assert.assertEquals("testavro", inputSystem);
    Assert.assertEquals("testavro-SIMPLE1-source", inputPhysicalName);
  }
  ...
  public void testTranslateComplex() {
    ...
    Assert.assertEquals(1, specGraph.getInputOperators().size());
    Assert.assertEquals("testavro", inputSystem);
    Assert.assertEquals("testavro-COMPLEX1-source", inputPhysicalName);
  }
  ...
  public void testTranslateStreamTableInnerJoin() {
    ...
    Assert.assertEquals("testavro-enrichedPageViewTopic-sink", output3PhysicalName);

    Assert.assertEquals(4, specGraph.getInputOperators().size());
    Assert.assertEquals("testavro", input1System);
    Assert.assertEquals("testavro-PAGEVIEW-source", input1PhysicalName);
    Assert.assertEquals("testavro", input2System);
    Assert.assertEquals("testavro-PROFILE-source", input2PhysicalName);
  ...
  public void testTranslateStreamTableRightJoin() {
    ...
    Assert.assertEquals(4, specGraph.getInputOperators().size());
    Assert.assertEquals("testavro", input1System);
    Assert.assertEquals("testavro-PROFILE-source", input1PhysicalName);
    Assert.assertEquals("testavro", input2System);
    Assert.assertEquals("testavro-PAGEVIEW-source", input2PhysicalName);
    Assert.assertEquals("kafka", input3System);
    Assert.assertEquals("sql-job-1-partition_by-table_1", input3PhysicalName);
    Assert.assertEquals("kafka", input4System);
    Assert.assertEquals("sql-job-1-partition_by-stream_1", input4PhysicalName);
