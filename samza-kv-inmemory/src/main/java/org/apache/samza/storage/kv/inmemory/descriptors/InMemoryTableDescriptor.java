...
import org.apache.samza.storage.kv.descriptors.BaseLocalTableDescriptor;
 ...
 */
public class InMemoryTableDescriptor<K, V> extends BaseLocalTableDescriptor<K, V, InMemoryTableDescriptor<K, V>> {
