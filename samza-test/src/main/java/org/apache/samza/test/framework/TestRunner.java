...
public class TestRunner {
  ...
  private void addSerdeConfigs(StreamDescriptor descriptor) {
    String streamIdPrefix = String.format(StreamConfigJava.STREAM_ID_PREFIX, descriptor.getStreamId());
    String keySerdeConfigKey = streamIdPrefix + StreamConfigJava.KEY_SERDE;
    String msgSerdeConfigKey = streamIdPrefix + StreamConfigJava.MSG_SERDE;
