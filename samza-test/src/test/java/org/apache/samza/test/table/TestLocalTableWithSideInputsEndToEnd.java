...
public class TestLocalTableWithSideInputsEndToEnd extends IntegrationTestHarness {
  ...
  private void runTest(String systemName, StreamApplication app, List<PageView> pageViews,
    ...
    configs.put(String.format(StreamConfigJava.SYSTEM_FOR_STREAM_ID, PAGEVIEW_STREAM), systemName);
    configs.put(String.format(StreamConfigJava.SYSTEM_FOR_STREAM_ID, PROFILE_STREAM), systemName);
    configs.put(String.format(StreamConfigJava.SYSTEM_FOR_STREAM_ID, ENRICHED_PAGEVIEW_STREAM), systemName);
