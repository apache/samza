 ...
 */
public interface StreamApplicationInitializer extends ApplicationInitializer<StreamApplication> {
  /**
   ...
   */
  StreamApplicationInitializer withContextManager(ContextManager contextManager);
