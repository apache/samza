  ...
  public String getStartingOffset(SystemStreamPartition ssp, SystemAdmin admin, String fileOffset, String oldestOffset) {
    ...
    if (fileOffset != null) {
      ...
      if (admin.offsetComparator(oldestOffset, resumeOffset) <= 0) {
        ...
        LOG.warn("Local store offset {} is lower than the oldest offset {} of the source stream. The values between these offsets cannot be restored.", resumeOffset, oldestOffset);
      }
    }
