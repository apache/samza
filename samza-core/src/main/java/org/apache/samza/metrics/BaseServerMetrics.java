...
public class BaseServerMetrics {
  ...
  public BaseServerMetrics(MetricsRegistry metricsRegistry, String group) {
    this.incomingRequests = metricsRegistry.newCounter(group, "incoming-requests");
    this.successfulResponses = metricsRegistry.newCounter(group, "successful-responses");
    this.failedResponses = metricsRegistry.newCounter(group, "failed-responses");
  }
}
