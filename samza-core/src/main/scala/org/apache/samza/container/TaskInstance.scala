...
class TaskInstance(
  ...
  val isInitableTask: Boolean = task.isInstanceOf[InitableTask]
  val isEndOfStreamListenerTask: Boolean = task.isInstanceOf[EndOfStreamListenerTask]
  val isClosableTask: Boolean = task.isInstanceOf[ClosableTask]
