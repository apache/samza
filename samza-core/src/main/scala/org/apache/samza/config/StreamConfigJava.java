  ...
  public class StreamConfigJava extends MapConfig {
    ...
    public String getPhysicalName(String streamId) {
      ...
      return get(String.format(PHYSICAL_NAME_FOR_STREAM_ID, streamId, streamId));
    }
    ...
    public boolean getResetOffset(SystemStream systemStream) {
      String resetOffset = getSamzaProperty(systemStream, CONSUMER_RESET_OFFSET);
    ...
    public String getDefaultStreamOffset(SystemStream systemStream) {
      return getSamzaProperty(systemStream, CONSUMER_OFFSET_DEFAULT);
    }
