...
public class TestJobModelManager {
  ...
  public void testLocalityMapWithHostAffinity() {
    ...
    assertEquals(jobModelManager.getAllContainerLocality(), new HashMap<String, String>() { { this.put("0", "abc-affinity"); } });
  }
  ...
  public void testLocalityMapWithoutHostAffinity() {
    ...
    assertEquals(jobModelManager.getAllContainerLocality(), new HashMap<String, String>() { { this.put("0", null); } });
  }
