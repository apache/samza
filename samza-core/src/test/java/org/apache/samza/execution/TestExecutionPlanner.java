...
public class TestExecutionPlanner {
  ...
  public void testCreateProcessorGraph() {
    ...
    JobGraph jobGraph = planner.createJobGraph(graphSpec.getConfig(), new JobGraphJsonGenerator(graphSpec), new JobGraphConfigureGenerator(graphSpec));
  ...
  public void testCreateJobGraphForTaskApplication() {
    ...
    JobGraph jobGraph = ExecutionPlanner.createJobGraph(config, new JobGraphJsonGenerator(taskAppDesc), new JobGraphConfigureGenerator(taskAppDesc));
